...
public class AppConfig {
    ...
    public Context context() throws NamingException {
        ...
        jndiProps.put(Context.PROVIDER_URL, "http://worker-service-ejb:8080");
    ...
    public JndiTemplate jndiTemplate() {
        ...
        env.put(Context.PROVIDER_URL, "http://worker-service-ejb:8080");
        return new JndiTemplate(env);
    }

    @Bean
    public MyEjbRemote myEjb() throws NamingException {
        return jndiTemplate().lookup("ejb:/worker-ejb-1.0-SNAPSHOT/MyEjb!com.soa.ejb.remotes.MyEjbRemote", MyEjbRemote.class);
    }
}
